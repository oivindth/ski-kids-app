    ...
    private var tableSection: some View {
        InfoCard(title: "How Your DIN Was Calculated", icon: "function", iconColor: AppColors.secondary) {
            VStack(alignment: .leading, spacing: 12) {
                ...
                if dinResult.isJuniorAdjusted {
                    DINStepRow(step: "4", title: "Junior Safety Adjustment", detail: "Children aged 9 and under get a one-level lower DIN code (per ISO 11088). This makes bindings release more easily, reducing injury risk for younger skiers whose bones and joints are still developing.")
                }
